...
export const appRoutes: Routes = [
  ...
  { path: 'visitors-charter', component: MainlayoutComponent, children: [
    { path: 'citizenscharter', component: CitizenscharterComponent }
  ]},
  { path: 'select-office', component: SelectofficeComponent },
  { path: 'user-information', component: UserinputComponent },
